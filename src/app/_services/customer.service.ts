...
export class CustomerService {
  ...
  saveBeforePurchase(customers: any[], grandServiceId: number): Observable<any> {
    const purchaseUrl = environment.baseAPIUrl + '/purchasetour/' + grandServiceId;
    return this.httpclient.post<any>(purchaseUrl, customers, httpOptions)
      .pipe(
        catchError(this.errorService.handleError)
      );
  }
